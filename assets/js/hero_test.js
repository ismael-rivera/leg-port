...
$(function () { // wait for document ready
							...
							// init controller
							var controller = new ScrollMagic.Controller({container: "#game"});
							...
							var scene2 = new ScrollMagic.Scene({triggerHook: 0.3, triggerElement: "#trigger", duration: 5670, offset: 2530});
								...
								// 	}
						        //});
								scene2.addIndicators({parent: ".mount-tops"}); // add indicators (requires plugin)
								//.on("enter", function (e){
								// 	if(slamdown === false){
							...
							var scene3 = new ScrollMagic.Scene({triggerHook: 0.3, triggerElement: "#trigger", duration: 8380, offset: 8210});
								...
								scene3.addIndicators({parent: ".mount-tops"}); // add indicators (requires plugin)
							...
							var scene4 = new ScrollMagic.Scene({triggerHook: 0.3, triggerElement: "#trigger", duration: 200, offset: 16590});
							 	...
							 	scene4.addIndicators({parent: ".mount-tops"}); // add indicators (requires plugin)
