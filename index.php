...
<html lang="en">
  <head>
    ...
    <title>Crodspring Studio: Mobile Web Design and Development</title>
  ...
  <body>
      ...
      <div class="container">
        <div class="navbar-header">
          <a class="navbar-brand" href="#">
              <img alt="Crowdspring Studio" src="...">
            </a>
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <li><a class="fa fa-home" href="#start">Start</a></li>
            <li><a class="fa fa-info" href="#portfolio">Portfolio</a></li>
    ...
    <div class="container" id="portfolio">
      ...
      <div class="row">
          <div class="col-md-2">
          <a href="#" class="thumbnail"><img src="..." alt="thumbnail"></a>
          <a href="#" class="thumbnail"><img src="..." alt="thumbnail"></a>
          <a href="#" class="thumbnail"><img src="..." alt="thumbnail"></a>
          </div>
          <div class="col-md-2">
